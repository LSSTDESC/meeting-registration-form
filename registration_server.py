...
def registered():
    ...
    participants = Participant.query.order_by(Participant.last_name, Participant.first_name).with_entities(Participant.first_name, Participant.last_name, Participant.affiliation, Participant.confirmed, Participant.chosenhub).all()
