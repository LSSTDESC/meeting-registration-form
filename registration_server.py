...
class Participant(db.Model):
    ...
    APC = db.Column(db.String(5))

    MIT = db.Column(db.String(5))
    HST = db.Column(db.String(5))
    AST = db.Column(db.String(5))
    PST = db.Column(db.String(5))
    PNT = db.Column(db.String(5))
    MST = db.Column(db.String(5))
    CST = db.Column(db.String(5))
    EST = db.Column(db.String(5))
    IET = db.Column(db.String(5))
    PRT = db.Column(db.String(5))
    CNT = db.Column(db.String(5))
    AGT = db.Column(db.String(5))
    BET = db.Column(db.String(5))
    CAT = db.Column(db.String(5))
    UTC = db.Column(db.String(5))
    ECT = db.Column(db.String(5))
    EET = db.Column(db.String(5))
    ART = db.Column(db.String(5))
    EAT = db.Column(db.String(5))
    MET = db.Column(db.String(5))
    NET = db.Column(db.String(5))
    PLT = db.Column(db.String(5))
    IST = db.Column(db.String(5))
    BST = db.Column(db.String(5))
    VST = db.Column(db.String(5))
    CTT = db.Column(db.String(5))
    JST = db.Column(db.String(5))
    ACT = db.Column(db.String(5))
    AET = db.Column(db.String(5))
    SST = db.Column(db.String(5))
    NST = db.Column(db.String(5))
